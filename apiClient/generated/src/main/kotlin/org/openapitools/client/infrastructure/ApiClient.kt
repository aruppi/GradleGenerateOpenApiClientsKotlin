...
open class ApiClient(val baseUrl: String, val client: OkHttpClient = defaultClient) {
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
        if (requestConfig.headers["CustomAuth"].isNullOrEmpty()) {
            if (apiKey["CustomAuth"] != null) {
                if (apiKeyPrefix["CustomAuth"] != null) {
                    requestConfig.headers["CustomAuth"] = apiKeyPrefix["CustomAuth"]!! + " " + apiKey["CustomAuth"]!!
                } else {
                    requestConfig.headers["CustomAuth"] = apiKey["CustomAuth"]!!
                }
            }
        }
    }
